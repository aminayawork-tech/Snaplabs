      ...
      <nav className="hidden md:flex fixed left-0 top-0 h-full w-[220px] flex-col bg-white border-r border-slate-200 shadow-[1px_0_0_#e2e8f0] z-50 px-3 py-5">
        ...
        <div className="mt-auto flex flex-col gap-3 pl-1">
          <button
            ...
            className="flex items-center gap-2 text-[0.75rem] text-slate-400 hover:text-slate-600 transition w-fit"
          >
          ...
          <p className="text-[0.625rem] text-slate-300 tracking-wide">snappymarketer · Claude + Firecrawl</p>
        </div>
      </nav>
